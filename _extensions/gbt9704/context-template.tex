...
% ==========================================================
% 各字体伪粗体变体 (\FakeBold 会切换回正文字体，不能混用)
% ==========================================================
\definefont[SimHeiBold]  [name:simhei*fakebold]
\definefont[GBKaiBold]   [name:kaitigb2312*fakebold]
\definefont[XiaoBiaoSongBold] [name:fzxiaobiaosongb05s*fakebold]

% ==========================================================
% 覆盖标题样式 — 与 LaTeX gbt9704.cls 一致
% ==========================================================
\setuphead[title][
  style={\XiaoBiaoSongBold\switchtobodyfont[22pt]},
  color=officialred,
  align=middle,
  number=no,
]
